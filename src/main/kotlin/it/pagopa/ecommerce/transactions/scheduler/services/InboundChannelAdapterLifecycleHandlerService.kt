...
class InboundChannelAdapterLifecycleHandlerService(
    ...
    /**
     * Invoke input command for all endpoints sending a message to the SpEL control bus input
     * channel
     */
    ...
    /**
     * Return all channels status querying the isRunning() method result sending a message to the
     * SpEL control bus input channel
     */
    ...
    fun getChannelStatus(channelName: String): ReceiverStatus {
        val controllerBusMessage =
            MessageBuilder.createMessage(
                "@${channelName}Endpoint.isRunning()",
