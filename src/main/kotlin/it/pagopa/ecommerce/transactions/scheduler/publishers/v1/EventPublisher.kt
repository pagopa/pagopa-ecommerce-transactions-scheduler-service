...
abstract class EventPublisher<E>(
...
) where E : TransactionEventV1<*> {

    private fun publishEvent(
        baseTransaction: BaseTransactionV1,
    ...
    abstract fun toEvent(baseTransaction: BaseTransactionV1): Mono<E>

    protected fun publishAllEvents(
        transactions: List<Pair<BaseTransactionV1, TransactionStatusDto>>,
